...
public class CoreAnnotations {
  ...
  /**
   * The CoreMap key for getting the Stanford Phrase Structure (dependency parsed) tag of a token.
   *
   * This key is typically set on token annotations.
   */
  public static class PhraseStructureAnnotation implements CoreAnnotation<String> {
    @Override
    public Class<String> getType() {
      return String.class;
    }  
